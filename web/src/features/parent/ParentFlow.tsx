...
export default function ParentFlow() {
  ...
  return <main className={styles.app}>
    ...
    <div className={screen === "login" ? `${styles.shell} ${styles.shellLogin}` : styles.shell}>
      ...
      {screen === "planReady" && child && <PlanReady child={child} duration={duration} items={playlist} viewKid={() => navigateScreen("preview")} done={() => router.push("/kid")} />}
      {screen === "preview" && child && <Preview child={child} items={playlist} next={() => router.push("/kid")} back={() => navigateScreen("planReady")} />}
